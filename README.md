...
This example is based on Techguns 2.0.1.3_pre2 and at least this version or newer is required as some things where fixed/added to Techguns to make it possible.
